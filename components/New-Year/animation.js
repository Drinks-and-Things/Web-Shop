...
export default function init(refCanvas) {
	canvas = refCanvas;
...
function render(t) {
	...
	// const bg = new Image();
	// bg.src =
	// 	'https://images.ctfassets.net/ch9q926xwa9k/5GzvNyOMgtEXcHcYcKSUru/e9bc3cf10db9205005f88bbc9c196cd1/vienna-2997032_1280.jpg';
